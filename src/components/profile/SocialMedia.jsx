		...
		<section id="social-media">
			<main className="container mt-20">
				...
				<p className="mt-10 text-justify indent-4 text-lg max-sm:text-base">
					Ikuti perjalanan Star Band SMPN 1 Purworejo di media sosial!
					Melalui akun resmi mereka, Star Band berbagi momen latihan,
					penampilan, hingga prestasi terbaru. Dengan mengikuti akun
					sosial media Star Band, Anda bisa tetap terhubung dan
					mendukung perkembangan mereka, serta menyaksikan aksi
					panggung dan kreativitas para anggota dalam bermusik. Jangan
					lupa untuk like, komen, dan share agar semangat bermusik
					Star Band semakin menyebar luas!
				</p>
